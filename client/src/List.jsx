        ...
        props.places.map((place) => (
          <Link
            to={
              subpage == "user-places"
                ...
                : "http://localhost:5173/account/bookings/" + props.booking._id
            }
            key={place._id}
          ...
          >
            ...
            <div className="grow">
              ...
              {props.checkInDate && (
                <div className="flex gap-1 items-center mt-7 -mb-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  {format(new Date(props.checkInDate), "yyy-MM-dd")} -{" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  {format(new Date(props.checkOutDate), "yyy-MM-dd")}
                </div>
              )}
